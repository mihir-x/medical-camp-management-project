            ...
            <Card className="max-w-2xl mx-auto">
                ...
                <div className="flex flex-col items-center pb-10">
                    ...
                    <div className=" space-x-5">
                        ...
                        <span className="text-sm text-gray-500 dark:text-gray-400"><span className="text-gray-800 font-bold">Phone Number:</span> {userAccount?.phone ? userAccount?.phone : 'n/a'}</span>
                    </div>
